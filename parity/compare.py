...
def compare_suite(name: str, cases: list, impl_batch) -> dict:
    ...
    failures = []
    for A, (e_ref, _, c_ref), (e, _, c) in zip(cases, refs, outs):
        mA = max_abs_entry(A)
        unit = EPS * mA
...
def main() -> int:
    ...
    for suite in args.suites:
        ...
        print(f"{suite:<11} n={rep['n']:<6} worst eval err "
